...
const CLOUDS: CloudDef[] = [
    // Top (hero area)
    { path: 0, x: '-3%', y: '3%', opacity: 0.35, drift: 'cloud-drift-1', duration: 50, scale: 1.1 },
    ...
    // Upper-mid
    { path: 0, x: '-6%', y: '18%', opacity: 0.30, drift: 'cloud-drift-4', duration: 60, flip: true },
    ...
    { path: 0, x: '60%', y: '42%', opacity: 0.25, drift: 'cloud-drift-3', duration: 65, flip: true, scale: 0.8 },

    // Lower-mid
    { path: 1, x: '-8%', y: '58%', opacity: 0.32, drift: 'cloud-drift-4', duration: 45, scale: 1.2 },
    { path: 2, x: '75%', y: '62%', opacity: 0.28, drift: 'cloud-drift-1', duration: 55, flip: true },

    // Bottom
    { path: 0, x: '8%', y: '78%', opacity: 0.35, drift: 'cloud-drift-2', duration: 40, scale: 1.3 },
...
export function SiteAtmosphere() {
    ...
    // Mouse parallax via CSS transform (single handler, no React re-renders)
    useEffect(() => {
        ...
        const tick = () => {
            ...
            const fgX = currentX * 20
            const fgY = currentY * 10
